...
public class LogisimMenuBar extends JMenuBar {
	...
	public static final LogisimMenuItem SIMULATE_ENABLE = new LogisimMenuItem("SimulateEnable", true);
	public static final LogisimMenuItem SIMULATE_STEP = new LogisimMenuItem("SimulateStep");
	public static final LogisimMenuItem TICK_ENABLE = new LogisimMenuItem("TickEnable", true);
